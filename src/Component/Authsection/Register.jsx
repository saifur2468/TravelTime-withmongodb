...
const Register = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      Swal.fire({ icon: "success", title: "Signup Successful!", text: "Your account has been created." });
      navigate("/");
    } catch (err) {
  ...
  return (
    <div className="flex items-center justify-center p-6">
      <div className="flex flex-col lg:flex-row items-center w-full max-w-6xl bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-white/20">
        ...
        {/* Left Side: Animation (Visible on LG screens) */}
        ...
        <div className="w-full lg:w-1/2 bg-white p-8 md:p-12 lg:p-16">
          <div className="max-w-md mx-auto">
            <h2 className="text-4xl font-extrabold text-gray-800 mb-2 text-center lg:text-left">Join Us</h2>
            <p className="text-gray-500 mb-8 font-medium text-center lg:text-left">Create an account to start your journey.</p>
            ...
            <form onSubmit={handleSignup} className="space-y-5">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border border-gray-200 rounded-xl text-gray-700 font-semibold hover:bg-gray-50 transition-all duration-200 shadow-sm hover:shadow-md"
              >
